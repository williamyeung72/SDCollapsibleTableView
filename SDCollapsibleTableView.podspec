...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SDCollapsibleTableView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/William Yeung/SDCollapsibleTableView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'William Yeung' => 'william.yeung@relaxops.com' }
  s.source           = { :git => 'https://github.com/William Yeung/SDCollapsibleTableView.git', :tag => s.version.to_s }
